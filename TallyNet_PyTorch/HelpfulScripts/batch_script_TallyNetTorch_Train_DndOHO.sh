...
#SBATCH --job-name DndOHO_TN-train
#SBATCH --mem 15gb 
#SBATCH --time 2:00:00
#SBATCH --output=./joboutput/DndOHO_Train-slurm-%j.out
#SBATCH --error=./joboutput/DndOHO_Train-slurm-%j.out
#SBATCH --nodes 1
...
DatabaseFlag=1 # which database to train on; 1=Dnd OneHand Oreba, 2=Dnd TwoHand Oreba, 3 = Dnd Clemson, 4=Dom One Hand OREBA, 5 = Dom Clemson
