...
# Define the CNN-MHA-GRU classification architecture with 3 convolution blocks
class GRU_Classifier_c3(nn.Module):
    def __init__(self, sample_length, total_axes, num_classes = 1, FINAL_ACTIVATION_FLAG = True,
                 d_gru1 = 48, d_mha = 96, d_gru2 = 48):
        super(GRU_Classifier_c3, self).__init__()
...
# end of Class def GRU_CLassifier_c3



# Define the CNN-MHA-GRU classification architecture with 3 convolution blocks
class GRU_Classifier_c5(nn.Module):
    def __init__(self, sample_length, total_axes, num_classes = 1, FINAL_ACTIVATION_FLAG = True,
                 d_gru1 = 48, d_mha = 96, d_gru2 = 48):
        super(GRU_Classifier_c5, self).__init__()
...
# end of Class def GRU_CLassifier_c5



class GRU_Classifier_noMHA(nn.Module):
    def __init__(self, sample_length, total_axes, num_classes = 1, FINAL_ACTIVATION_FLAG = True,
                 d_gru1 = 48, d_mha = 96, d_gru2 = 48):
        super(GRU_Classifier_noMHA, self).__init__()
...
# end of Class def GRU_Classifier_noMHA

class GRU_Classifier_noGRU(nn.Module):
    def __init__(self, sample_length, total_axes, num_classes = 1, FINAL_ACTIVATION_FLAG = True,
                 d_gru1 = 48, d_mha = 96, d_gru2 = 48):
        super(GRU_Classifier_noGRU, self).__init__()
        ...
        self.attention_prep = nn.Linear(32, mha_d)
        self.attention_block = nn.MultiheadAttention(mha_d, mha_numHeads, batch_first = True)
...
# end of Class def GRU_Classifier_noGRU



class GRU_Classifier_oneGRU(nn.Module):
    def __init__(self, sample_length, total_axes, num_classes = 1, FINAL_ACTIVATION_FLAG = True,
                 d_gru1 = 48, d_mha = 96, d_gru2 = 48):
        super(GRU_Classifier_oneGRU, self).__init__()
...
# end of Class def GRU_CLassifier_oneGRU




class GRU_Classifier_twoGRU(nn.Module):
    def __init__(self, sample_length, total_axes, num_classes = 1, FINAL_ACTIVATION_FLAG = True,
                 d_gru1 = 48, d_mha = 96, d_gru2 = 48):
        super(GRU_Classifier_twoGRU, self).__init__()
...
# end of Class def GRU_CLassifier_twoGRU
...
def Create_GRU_Classifier(sample_length, total_axes, MODEL_ARCH_FLAG = 0):
    ...
    ##### TALLYNET OPTIONS #####
    elif MODEL_ARCH_FLAG == 100: # Default
        # Close to Upper param count in original paper
        model = GRU_Classifier(sample_length, total_axes, num_classes = num_outputs,
        ...
        model = GRU_Classifier(sample_length, total_axes, num_classes = 1, 
                    FINAL_ACTIVATION_FLAG = False,
                    d_gru1 = 32, d_mha = 64, d_gru2 = 32)
    elif MODEL_ARCH_FLAG == 102:
        model = GRU_Classifier(sample_length, total_axes, num_classes = 1, 
                    FINAL_ACTIVATION_FLAG = False,
                    d_gru1 = 128, d_mha = 256, d_gru2 = 128)


    ##### TallyNet Additional CNN Block OPTIONS #####
    elif MODEL_ARCH_FLAG == 200: # Default
        # Close to Upper param count in original paper
        model = GRU_Classifier_c3(sample_length, total_axes, num_classes = num_outputs,
                    FINAL_ACTIVATION_FLAG = False)


    ##### TallyNet Additional CNN Block OPTIONS #####
    elif MODEL_ARCH_FLAG == 300: # Default
        # Close to Upper param count in original paper
        model = GRU_Classifier_c5(sample_length, total_axes, num_classes = num_outputs,
                    FINAL_ACTIVATION_FLAG = False)

    ##### TallyNet Additional Remove Component #####
    elif MODEL_ARCH_FLAG == 401: # Default
        # Close to Upper param count in original paper
        model = GRU_Classifier_noMHA(sample_length, total_axes, num_classes = num_outputs,
                    FINAL_ACTIVATION_FLAG = False)
    elif MODEL_ARCH_FLAG == 402: # Default
        # Close to Upper param count in original paper
        model = GRU_Classifier_noGRU(sample_length, total_axes, num_classes = num_outputs,
                    FINAL_ACTIVATION_FLAG = False)
    elif MODEL_ARCH_FLAG == 403: # Default
        # Close to Upper param count in original paper
        model = GRU_Classifier_oneGRU(sample_length, total_axes, num_classes = num_outputs,
                    FINAL_ACTIVATION_FLAG = False)
    elif MODEL_ARCH_FLAG == 404: # Default
        # Close to Upper param count in original paper
        model = GRU_Classifier_twoGRU(sample_length, total_axes, num_classes = num_outputs,
                    FINAL_ACTIVATION_FLAG = False)
