...
#SBATCH --job-name CleanClem_TN-train
#SBATCH --mem 32gb 
#SBATCH --time 48:00:00
#SBATCH --output=./joboutput/CleanClem_Train_largeWS-slurm-%j.out
#SBATCH --error=./joboutput/CleanClem_Train_largeWS-slurm-%j.out
#SBATCH --nodes 1
...
DatabaseFlag=3 # which database to train on; 1=Dnd OneHand Oreba, 2=Dnd TwoHand Oreba, 3 = Dnd Clemson, 4=Dom One Hand OREBA, 5 = Dom Clemson
