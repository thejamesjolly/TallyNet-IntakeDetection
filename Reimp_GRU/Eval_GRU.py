...
if __name__ == '__main__':
    ...
    CUT_sec = 10.0 # default window size
    ...
    LABEL_OFFSET = 1.0 # Using point-wise label at end of the window 
    ...
    myModel = Create_GRU_Classifier(sample_length, total_axes, MODEL_ARCH_FLAG)
