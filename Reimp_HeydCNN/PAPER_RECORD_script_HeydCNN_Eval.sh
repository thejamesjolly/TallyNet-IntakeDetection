...
if [[ $EvalSwitch -eq 1 ]]; then
	...
	python Eval_HeydCNN.py Models/ClemDND_HeydCNN_0/models/fold2 3 2 0.65 >> Results/DndClemson0_"$RunID".txt
	python Eval_HeydCNN.py Models/ClemDND_HeydCNN_0/models/fold3 3 3 0.65 >> Results/DndClemson0_"$RunID".txt
